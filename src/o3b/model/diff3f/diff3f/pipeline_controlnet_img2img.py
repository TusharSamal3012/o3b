...
from o3b.model.diff3f.diff3f.unet_2d_condition import UNet2DConditionModel
...
class StableDiffusionControlNetImg2ImgPipeline(
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if i == (num_inference_steps - 1) and not return_image:
                    return StableDiffusionPipelineOutput(images=f_map[0], nsfw_content_detected=[True])
        ...
        return StableDiffusionPipelineOutput(images=[f_map[0], image], nsfw_content_detected=has_nsfw_concept)
