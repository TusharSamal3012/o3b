...
from genpose2.utils.misc import exists_or_mkdir, get_rot_matrix, transform_batch_pts
...
def create_grid_image(batch_pts, batch_pred_pose, batch_gt_pose, batch_color, pose_mode='quat_wxyz', inverse_pose=True):
    B = batch_pts.shape[0]
...
def save_video(save_path, batch_pts, batch_pred_pose_list, batch_gt_pose, batch_color, fps, pose_mode='quat', inverse_pose=True):
