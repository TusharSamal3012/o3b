...
class GaussianDiffusion:
    ...
    def q_sample(self, x_start, t, noise=None):
        ...
        return (
            _extract_into_tensor(self.sqrt_alphas_cumprod, t, x_start.shape).to(x_start) * x_start
            + _extract_into_tensor(self.sqrt_one_minus_alphas_cumprod, t, x_start.shape).to(x_start) * noise
        )
