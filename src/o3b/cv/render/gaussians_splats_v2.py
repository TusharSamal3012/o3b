...
import torch
from o3b.cv.geometry.transform import proj3d2d_broadcast, transf3d_broadcast
...
def rasterize_gaussians(
    ...
    for b in range(B):
        ...
        # from o3b.cv.visual.show import show_scene2d, show_img, show_imgs
        ...
        from o3b.cv.select import append_const_front
