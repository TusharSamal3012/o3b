...
class Diff3FModel(OD3D_Model):
    ...
    def _forward_object_batch(self, batch):
        ...
        import gc
        from od3d_basic.model.diff3f.diff3f_utils import compute_features
    ...
    def forward(self, frames_gt, frames_pred=None):
        ...
        from od3d_basic.model.diff3f.diff3f.diff3f import arange_pixels
        from od3d_basic.model.diff3f.diff3f.diffusion import add_texture_to_render
        from od3d_basic.model.diff3f.diff3f.dino import get_dino_features
