from od3d_basic.model.diff3f.diff3f.dataloaders.surreal import Fake_pair_indices
from od3d_basic.model.diff3f.diff3f.dataloaders.point_cloud_dataset import PointCloudDataset, get_max_dist
import itertools
import os
import os.path
import numpy as np
