...
import torch
from od3d_basic.cv.geometry.transform import rotation_6d_to_matrix, transf4x4_from_rot3x3_and_transl3
    ...
    def forward(self, frames_gt, frames_pred=None):
        ...
        if self.out_dims[0] == 3: # transl
            ...
            if frames_pred.obj_tform4x4_obj_nocs_0c is not None:
                from od3d_basic.cv.geometry.transform import transf3d_broadcast, tform4x4_broadcast, inv_tform4x4
        ...
        if self.out_dims[1] == 6: # rot
            ...
            if frames_pred.obj_tform4x4_obj_nocs_0c is not None:
                from od3d_basic.cv.geometry.transform import transf3d_broadcast, rot3x3, inv_tform4x4, rem_scale_tform4x4
        ...
        if self.out_dims[2] == 3:
            ...
            if frames_pred.obj_tform4x4_obj_nocs_0c is not None:
                from od3d_basic.cv.geometry.transform import rot3d_broadcast, get_scale1d_tform4x4
