...
_CLASS_TO_MODULE: dict[str, str] = {
    "SequentialTransform": "od3d_basic.transform.sequential.transform",
    "RGB_UInt8ToFloat":    "od3d_basic.transform.rgb_uint8_to_float.transform",
    "RGB_Normalize":       "od3d_basic.transform.rgb_normalize.transform",
}
