...
from od3d_basic.data.modalities import Object, ObjectPair
from od3d_basic.dataset.densematcher.enum import DENSEMATCHER_CATEGORIES

_MESH_EXTS = {".obj", ".ply", ".glb", ".gltf", ".stl", ".fbx"}

_DEFAULT_URL = (
    "https://ucc7d8aa77eacb8d89d3b73c3a79.dl.dropboxusercontent.com/zip_download_get/"
    "ClBzGsaSIlM4fmlreUGnGU5l1uOmV3buIMY8IlIqw1V7F3TFog7-uXvcs943fPIpmuL5e8JuSxgqktR5nYWwp3f"
    "sdJnQDVYV27Mkz1h4UM9q2g?_download_id=482065677110575851872398891395550844345657359396627581130567466206"
...
class DenseMatcher(ConfigurableDataset):
    ...
    def _load_object_from_row(self, row: dict) -> Object:
        ...
        from od3d_basic.dataset.housecorr3d.dataset import _want, _load_kpts3d_by_id
    ...
    def fetch(cls, cfg, *, url: Optional[str] = None) -> None:
        ...
        from od3d_basic.dataset.housecorr3d.dataset import _download_progress
